...
public class ListQueues extends Demo {
  private final AmazonSQS sqs;
  @Inject public ListQueues(final AmazonSQS sqs) {
    this.sqs = sqs;
  }

  @GET @Path("/run") @Produces("application/json")
  public DemoOutput run() {
    echo("running sqs.listQueues()...");
    try {
  ...
  @Override public String getTitle() { return "List Queues"; }
  @Override public String getDescription() {
    return "This demo uses the method sqs.listQueues() " +
